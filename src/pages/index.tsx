...
export default function Home() {
  return (
    <div className='min-h-screen font-sans bg-gradient-to-br from-gray-900 to-black text-gray-100'>
      <Navbar />
...
const commonStyling = {
  button:
    'bg-gradient-to-r from-gray-700 to-teal-500 hover:from-gray-600 hover:to-teal-400 active:from-teal-600 text-white px-8 py-3 rounded-full shadow-2xl transform transition hover:scale-105 motion-reduce:transform-none focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800',
  sectionTitle:
    'text-4xl font-bold mb-6 text-gradient bg-gradient-to-r from-gray-700 to-teal-500',
...
const Navbar = () => (
  <nav className='fixed top-0 w-full z-50 p-6 bg-black bg-opacity-60 backdrop-blur-lg backdrop-saturate-200'>
    <div className='container mx-auto flex justify-between items-center'>
      <h1 className='text-3xl font-extrabold text-white transform hover:scale-105 transition-transform'>
        KafkaTrace
      </h1>
...
const LinkButton = ({ href, children }) => (
  <Link href={href}>
    <a className='text-white hover:text-gray-400 transition duration-200'>
      {children}
    </a>
  </Link>
);
...
const Hero = () => (
  <section className='relative text-center py-32 bg-gradient-to-tl from-black to-teal-500 text-white overflow-hidden'>
    ...
    <div className='z-10 relative transform transition-transform duration-700 hover:scale-105 hover:skew-y-[-6deg]'>
      {/* Hero title */}
      <h2 className='text-5xl font-extrabold mb-4 text-teal-500 transform transition-transform duration-700 hover:scale-110'>
        Welcome to{' '}
        <span className='bg-clip-text text-transparent bg-gradient-to-r from-gray-600 to-teal-400 hover:from-teal-500 hover:to-gray-700'>
          KafkaTrace
        </span>
      </h2>
      {/* Hero subtitle */}
...
const PrimaryButton = ({ href, children }) => (
  <a
    href={href}
    className={`bg-gradient-to-r from-teal-500 to-teal-700 text-white px-8 py-3 rounded-lg shadow-md transform transition hover:scale-105 motion-reduce:transform-none focus:outline-none focus:ring-2 focus:ring-teal-500 inline-block ${commonStyling.button}`}>
    {children}
  </a>
);
...
const FeatureBlock = ({ icon, title, description }) => (
  <div
    className={`p-8 rounded-lg shadow-md bg-gradient-to-tr from-teal-500 to-teal-700 hover:from-teal-400 hover:to-teal-600 transition duration-300 ease-in-out transform hover:scale-105 ${commonStyling.button}`}>
    <div className='text-6xl mb-8 text-teal-300'>{icon}</div>
    <h3 className='text-3xl mb-6 font-bold text-gray-300'>{title}</h3>
    <p className='text-lg text-gray-400'>{description}</p>
  </div>
);

const Teams = () => (
  <section className='py-16 bg-gradient-to-r from-black to-teal-700 text-gray-300'>
...
const TeamMember = ({ img, name, role }) => (
  <div className='group flex flex-col items-center p-6 rounded-lg shadow-2xl bg-gradient-to-tr from-gray-700 to-gray-900 transform transition-transform duration-300 ease-in-out hover:scale-105'>
    <div className='relative w-40 h-40 mb-8 overflow-hidden rounded-full group-hover:rotate-6 transition-transform duration-300 ease-in-out'>
      <img
        src={img}
        alt={`${name}, ${role}`}
        className='w-full h-full object-cover border-4 border-teal-500 transform group-hover:border-teal-400 group-hover:rotate-[-6deg] transition-transform duration-300 shadow-lg'
      />
    </div>
    <h3 className='text-2xl font-extrabold mb-4 text-gray-300'>{name}</h3>
    <p className='text-lg text-gray-400'>{role}</p>
  </div>
);

const Subscribe = () => (
  <section className='py-16 px-8 md:px-16 bg-gradient-to-r from-black to-teal-700 overflow-hidden mb-16'>
    <h2
      className={`${commonStyling.sectionTitle} text-white font-extrabold text-4xl mb-4 bg-clip-text text-transparent bg-gradient-to-br from-teal-500 to-teal-600`}>
      Stay Updated
    </h2>
    ...
    <form className='mt-6 flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4'>
      <input
        type='email'
        className='flex-grow p-3 bg-gray-800 rounded-md focus:ring focus:ring-teal-500 focus:shadow-xl placeholder-gray-500 transition duration-300 hover:bg-gray-700'
...
const GitHubButton = () => (
  <a
    ...
    className='btn inline-flex items-center bg-gradient-to-r from-teal-500 to-teal-700 hover:from-teal-400 hover:to-teal-600 text-white p-3 px-6 rounded-xl shadow-lg transform transition-transform hover:scale-105 duration-300 ease-in-out relative'>
    <svg
      xmlns='http://www.w3.org/2000/svg'
...
const GmailButton = () => (
  <a
    ...
    target='_blank'
    rel='noopener noreferrer'
    className='btn inline-flex items-center bg-red-600 hover:bg-red-500 text-white p-3 px-6 rounded-xl shadow-lg transform transition-transform hover:scale-105 duration-300 ease-in-out relative'>
    <svg
      xmlns='http://www.w3.org/2000/svg'
      className='h-5 w-5 mr-2'
      viewBox='0 0 24 24'
