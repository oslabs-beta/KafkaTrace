...
export default function CodeSnippet ({code}: CodeSnippetProps) {
  ...
  return (
  <div className='border-2 p-3 max-w-lg shadow-inner rounded-lg bg-white e-105'>
    <div className="flex justify-between">
      <div className='flex items-center justify-start p-2 text-black-400 space-x-1 mb-2'>
